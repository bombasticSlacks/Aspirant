...
As [Production Work](Activities#Production%20Work), you can transform matter into gold. Perform a [[]] with a difficulty of your choice, if successful, you receive gold nuggets worth 3 times the difficulty in silver. This requires an [Alchemists Tool Set](Game/Example-Gear.md#Alchemists%20Tool%20Set).
...
You count as having a [Trauma Kit](Game/Example-Gear.md#Trauma%20Kit) even if not carrying one. However, any related medical skill tests are performed at a -2.
...
If your character has a [Trap Kit](Game/Example-Gear.md#Trap%20Kit), your payloads can be much more exotic, but the skill test becomes [Application](Core/Intelligence#Application), and they take longer to prepare. They can include things like:
...
As [Production Work](Activities#Production%20Work), you can repair a damaged item or up to 5 rounds of ammunition. This requires a [Weapons Tool Set](Game/Example-Gear.md#Weapons%20Tool%20Set), but no additional materials or currency.
