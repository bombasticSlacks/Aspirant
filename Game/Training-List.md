...
| ----------------- | -------- |
| Bashing           | Advanced |
| Fior Di Battaglia | Advanced |
| Hyper Block       | Advanced |
| Iaido             | Advanced |
| Master Block      | Advanced |
| Master Of Arms    | Advanced |
...
| Sunderer          | Basic    |
| Weapon Expert     | Basic    |
| Martial Training  | Basic    |

### Animal Handling

| Name           | Type         |
| -------------- | ------------ |
| Mounted Expert | Introductory |
| Trampler       | Basic        |
| Battle Mount   | Basic        |
| Horse Control  | Advanced     |
| Houndmaster    | Basic        |
| Proper Packing | Basic        |
| Pack Animals   | Basic        |
...
##### Houndmaster
If you have the With Me #TODOLINK You can control animals in combat like NPC’s.
...
| Name              | Type         |
| ----------------- | ------------ |
| Ambidextrous      | Advanced     |
| Defensive Offhand | Basic        |
| Double Strike     | Introductory |
| Massive Inertia   | Basic        |
| Multitasking      | Basic        |
...
| Name                  | Type         |
| --------------------- | ------------ |
| Armed To The Teeth    | Basic        |
| Cross Arm Block       | Basic        |
| Grand Defender        | Advanced     |
| Head Down             | Basic        |
| Heavy Hitter          | Advanced     |
| Iron Curtain          | Advanced     |
| Perfect Fit           | Basic        |
| Phalanx               | Basic        |
| Protector             | Basic        |
| Roll With The Punches | Advanced     |
| Second Skin           | Advanced     |
| Shield Expert         | Introductory |
| Steel Wall            | Basic        |
| Strapped              | Basic        |
| Sword and Board       | Advanced     |
| Terminator            | Basic        |
...
| Name                | Type     |
| ------------------- | -------- |
| Comfortable Footing | Basic    |
| Defensive Combatant | Basic    |
| Feint               | Basic    |
| Fencer              | Advanced |
| Fight Smart         | Basic    |
| Flowing Defence     | Basic    |
| Helmsman            | Advanced |
| Sole Combatant      | Basic    |
| Whirlwind           | Advanced |
...
| -------------------- | -------- |
| Double Tap           | Advanced |
| Efficient Rounds     | Basic    |
| Eradicate            | Advanced |
| Improvised Munitions | Basic    |
| Marksman             | Advanced |
| Olympian             | Basic    |
| Pin Down             | Basic    |
| Point Man            | Advanced |
...
| Name           | Type         |
| -------------- | ------------ |
| Black Belt     | Introductory |
| Crane Style    | Advanced     |
| Dragon Style   | Advanced     |
| Drunk Boxing   | Advanced     |
| Fleet Footed   | Basic        |
| Flesh Prison   | Basic        |
| Iron Fists     | Basic        |
| Judo           | Advanced     |
| Leverage Holds | Basic        |
| Living Weapon  | Basic        |
| Pankration     | Advanced     |
| Rip and Tear   | Advanced     |

### Berserker

| Name                | Type     |
| ------------------- | -------- |
| Adrenaline Response | Advanced |
| Bushwhacker         | Basic    |
| Cleave              | Basic    |
| Damaging            | Basic    |
| Greater Cleave      | Advanced |
| Meat Shield         | Basic    |
| Monstrous Leap      | Basic    |
| Planted             | Basic    |
| Powerful Strike     | Basic    |
| Relentless Attack   | Basic    |
| Thunderous Charge   | Basic    |
| Vivisector          | Advanced |
...
| Name               | Type         |
| ------------------ | ------------ |
| Inspiring Strike   | Basic        |
| Grand Leadership   | Advanced     |
| Conscription       | Basic        |
| Sanctuary          | Basic        |
| Unending Fury      | Advanced     |
| Inspiring Shout    | Advanced     |
| Heretic            | Basic        |
| Lookout Sir!       | Basic        |
| Fasting            | Basic        |
| Inspiring Presence | Basic        |
| With Me            | Introductory |
| Blessed            | Basic        |
| Faithful           | Basic        |
...
| Tumbling    | Introductory | As skilled work, you can dance. Make a variable difficulty acrobatics skill test, you receive 2 silver per step of success.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Knowledgeable Geographer  | Basic    | Your knowledge extends to geography.                                                                                                                                                                                   |
| Knowledgeable Historian   | Basic    | Your knowledge extends to history.                                                                                                                                                                                     |
...
| Knowledgeable Interpreter | Basic    | Your knowledge extends to religious groups, otherworldly entities and superstitions.                                                                                                                                   |
...
|Trauma Doc|Advanced|If you successfully perform first aid on someone, they no longer have any ongoing negatives from injuries. You can also make a medical test to treat ongoing negatives that were caused by someone else's medical work.|
...
| Field Dressing     | Advanced    | When collecting bits from creatures, you may collect one additional.                                                                                                                                                                                                                                                                                      |
| Home In Nature     | Basic    | You receive a +1 to all skill tests related to surviving and navigating natural environments.                                                                                                                                                                                                                                                             |
| Interrogator       | Advanced    | If you have someone detained for any meaningful amount of time, they can hide nothing from you.                                                                                                                                                                                                                                                           |
...
| Live off the Land  | Advanced    | You don’t require food when travelling through most areas.                                                                                                                                                                                                                                                                                                |
...
| Take Down Expert   | Master | After successfully performing a grapple special manoeuvre against someone, you may perform one grapple action on them immediately.                                                                                                                                                                                                                        |
...
| Name                 | Type     | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Assassination        | Advanced | When attacking an unaware target, if you succeed at the skill test you may choose for them to take a lethal injury or go unconscious.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Hide in Plain Sight  | Master   | You do not need an item or object to hide behind when attempting to hide.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Master Thief         | Master   | You may roll subterfuge to immediately use items and equipment stored on other characters in combat. Using the equipment would take the action it normally would.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Poisoner             | Basic    | You can apply poison to a weapon during combat as an action. It lasts until the end of combat.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Preternatural Senses | Advanced | You can manoeuvre perfectly well in the dark or when your vision is otherwise impaired.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| Tour Guide           | Advanced | When rolling subterfuge to hide, move silently etc. you can include a small group of people at no negative.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
|Vitruvian|Master|Your body is perfect and loses all scarring. Immune to poison, mutations you take don’t have any obvious signs. Going above your Max Toxicity temporarily doesn’t cause injury (though you still can’t take more modifications than that).|
...
|Masters Touch|Master|The armour you craft is master worked quality.|
